...
<div id="wrapper">
	...
	<div class="header_style_wrapper">
		...
		?>
    <div class="top_bar <?php if((is_single() && $post_type !== 'tours') && !empty($pp_page_bg) && !empty($page_menu_transparent)) { ?>hasbg<?php } ?> <?php if(!empty($page_revslider) && $page_revslider!= -1 && !empty($page_menu_transparent)) { ?>hasbg<?php } ?> <?php if(isset($pp_homepage_style) && !empty($pp_homepage_style)) { echo $pp_homepage_style; } ?>">
